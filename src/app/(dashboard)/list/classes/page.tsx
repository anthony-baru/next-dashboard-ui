...
const ClassList = () => {
  const renderRow = (classData: Class) => (
    <tr
      key={classData.id}
    ...
    >
      <td className="flex items-center gap-4 p-4">
        <h3 className="table-cell">{classData.name}</h3>
      </td>
      <td className="hidden md:table-cell  ">{classData.capacity}</td>
      <td className="hidden md:table-cell  ">{classData.grade}</td>
      <td className="hidden md:table-cell  ">{classData.supervisor}</td>
      <td>
          ...
          {role === "admin" && (
            <>
              <FormModal
                ...
                id={classData.id}
              />
              <FormModal table="class" type="delete" id={classData.id} />
            </>
          )}
        </div>
      </td>
