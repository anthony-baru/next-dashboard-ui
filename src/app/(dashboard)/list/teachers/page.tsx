...
const TeacherList = () => {
  const renderRow = (teacher: Teacher) => (
    ...
    >
      ...
      <td className="hideen md:table-cell ">{teacher.teacherId}</td>
      <td className="hideen md:table-cell ">{teacher.subjects.join(", ")}</td>
      <td className="hideen md:table-cell ">{teacher.classes.join(", ")}</td>
